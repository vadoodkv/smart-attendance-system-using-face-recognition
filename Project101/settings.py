...
# Optional if you want a central static folder in the project root
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'vadoodkv@gmail.com'
EMAIL_HOST_PASSWORD = 'zfkq gxvh xwkd phny'  # Use an App Password if using Gmail
